...
curl -iv -X GET -H "Content-Type: application/json" -H "Accept: application/json" -H "X-Auth-Token: $token"  https://vpc.eu-de.otc.t-systems.com/v2.0/lbaas/healthmonitors/$1
